...
class TT100KDataset(Dataset):
    def __init__(self, data_dir, annotation_file, split='train', transform=None, target_classes=None):
        self.data_dir = data_dir
        self.split = split
        self.transform = transform

        # Load annotation file into a LOCAL variable (Do not use self.annotations!)
        ...
        if target_classes is not None:
            ...
            self.classes = annotations['types']
        ...
        # Loop through the local annotations variable
        ...
        # Once this function finishes, the giant 'annotations' dictionary is automatically
        # deleted from RAM, leaving only your lightweight self.images list!
...
trainset = TT100KDataset(
    ...
    target_classes=tt100k_class_names # <-- ADD THIS
)
...
train_loader = DataLoader(
    ...
    shuffle=True,
    num_workers=8,      # Works perfectly now!
...
mama_test_loss_list = []
mama_map_list = [] # <--- ADD THIS
mama_iou_list = [] # <--- ADD THIS
...
moex_test_loss_list = []
moex_map_list = [] # <--- ADD THIS
moex_iou_list = [] # <--- ADD THIS
